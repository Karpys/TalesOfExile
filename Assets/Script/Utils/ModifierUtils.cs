                ...
                {ModifierType.AddThrowRockPassif, (m, e) =>
                    {
                        ...
                        if (!added)
                        {
                            e.Buffs.AddPassive(new RockThrowBuff(e, e, BuffType.RockThrowBuff,BuffGroup.Buff,0,m.FloatValue,null,false,BuffLibrary.Instance.RockThrowSpellInfo),PassiveBuffType.RockThrowPassive);
                        }
                    }
                },
            };
