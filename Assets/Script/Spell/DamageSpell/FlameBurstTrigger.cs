...
namespace KarpysDev.Script.Spell.DamageSpell
{
    ...
    public class FlameBurstTrigger : DamageSpellTrigger
    {
        ...
        protected override void EntityHit(BoardEntity entity, TriggerSpellData spellData, Vector2Int origin, CastInfo castInfo)
        {
            ...
            entity.Buffs.AddBuff(new DotDebuff(m_AttachedSpell.AttachedEntity,entity,BuffType.BurnDotDebuff,BuffGroup.Debuff,m_BurnDuration,m_BurnValue,BuffConst.NotImplemented,false,SubDamageType.Fire),VisualEffectType.FireDot);
        }
    }
}