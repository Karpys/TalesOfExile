...
namespace KarpysDev.Script.Entities.BuffRelated
{
    public class RockThrowBuff : Buff
    {
        ...
        public RockThrowBuff(BoardEntity caster, BoardEntity receiver,BuffType buffType,BuffGroup buffGroup,int cooldown, float buffValue, BuffCategory[] categories, bool ignoreFirstBehaveTurn, SpellInfo rockThrow) : base(caster, receiver,buffType, buffGroup, cooldown, buffValue, categories,ignoreFirstBehaveTurn)
        {
